...
class AlertReportDeleteWidget extends StatelessWidget {
  const AlertReportDeleteWidget({Key? key}) : super(key: key);
              ...
              Row(
                ...
                children: [
                  ...
                  CommonPrimaryButton(
                      ...
                      radius: 13.2.w,
                      clickAction: () {
                        if (alertModel.baseController != null) {
                          controller.deleteReport(alertModel.baseController!);
                        } else {
                          ToastUtil.show("为获取到controller");
                        }
                      }),
                ],
              ),
